...
function simpanJI()
{
	...
	else
	{
		...
		param='kode='+kode+'&jenisijin='+jenisijin+'&iscuti='+iscutis+'&ispotong='+ispotongs+'&isdayoff='+isdayoffs+'&kdabsen='+kdabsen+'&method='+met;
...
function fillField(kode,jenis,ic,ip,idf,kdabsen)
{
