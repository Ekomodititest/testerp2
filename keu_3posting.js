...
function listPosting() {
    ...
    if(x=='gudang')
	 ...
	 else if(x=='gajibulanan') 
          post_response_text('keu_slave_3gajibulanankaryawan.php', param, respon);       
}
...
function prosesGajiBulanan()
{
	var periode = document.getElementById('periode').options[document.getElementById('periode').selectedIndex].value;
	param ='periode='+periode;
	 tujuan='keu_slave_prosesAlokasiGajiBulanan2.php';
	if(confirm('Anda yakin melakukan proses pengalokasian gaji bulanan?')){
		post_response_text(tujuan, param, respon);
	}
