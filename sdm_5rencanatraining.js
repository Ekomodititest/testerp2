...
function simpan()
{
    ...
    if(namatraining=='' || hargaperpeserta=='' || levelpeserta=='' || penyelenggara=='' || tanggal1=='' || tanggal2=='' || persetujuan=='' || hrd=='')
    {
    ...
    else
    {
        ...
        if(document.getElementById('kodetraining').disabled){
            ...
            param='kamar=edit'+'&kodetraining='+kodetraining;
        }else{
            //param='kamar=save&tahunbudget='+tahunbudget+'&kodetraining='+kodetraining;
            param='kamar=save'+'&kodetraining='+kodetraining;
        }
...
function edittraining(kodetraining,namatraining,levelpeserta,penyelenggara,hargaperpeserta,tanggal1,tanggal2,persetujuan,hrd,deskripsitraining,hasildiharapkan)
{
