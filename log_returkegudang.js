...
if(document.getElementById('sloc').value=='') {
  ...
  setSloc('simpan');
  content= "<div>";
  content+="<fieldset>GI:<input type=text id=textpo class=myinputtext onkeypress=\"return tanpa_kutip(event);\" maxlength=25><button class=mybutton onclick=goCariGi()>Go</button> </fieldset>";
...
function goCariGi(){
                ...
                {   
                param='nomorlama='+nomorlama+'&proses=carigi';
...
function goCariBarang(){
                ...
                param='kodebarang='+kodebarang+'&nomorlama='+nomorlama+'&proses=caribarang';
                tujuan = 'log_slave_cariGi.php';
                post_response_text(tujuan, param, respog);			
            }
                function respog(){
