...
function searchTrans() {
    ...
    var where = '[["notransaksi","'+notrans.value+'"],["tanggal","'+tanggalR+'"],["jumlah","'+remove_comma_var(rupiah.value)+'"]]';
...
function goToPages(page,shows,where) {
    ...
    post_response_text('keu_slave_kasbank_new_payment.php?proses=showHeadList', param, respon);
}
...
function showAdd() {
    ...
    post_response_text('keu_slave_kasbank_new_payment.php?proses=showAdd', param, respon);
}
...
function showEditFromAdd() {
    ...
    post_response_text('keu_slave_kasbank_new_payment.php?proses=showEdit', param, respon);
}
...
function addDataTable() {
    ...
    post_response_text('keu_slave_kasbank_new_payment.php?proses=add', param, respon);
}
...
function editDataTable() {
    ...
    post_response_text('keu_slave_kasbank_new_payment.php?proses=edit', param, respon);
}
...
function deleteData(num) {
    ...
    post_response_text('keu_slave_kasbank_new_payment.php?proses=delete', param, respon);
}
