...
function simpanVhc()
{
        ...
        else
        {
                if (confirm('Saving..?')) {
						...
						noakun = trim(noakun);
                        param = 'jenisvhc=' + jenisvhc + '&noakun=' + noakun + '&namajenisvhc=' + namajenisvhc + '&method=' + met;
...
kodebarang,kepemilikan,kodetraksi,tglakhirstnk,tglakhirkir,tglakhirijinbm,tglakhirijinang)
{
