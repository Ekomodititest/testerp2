...
function cariList(num){
	...
	tujuan = 'keu_slave_posting_pembayaran_tagihan_masuk.php';
...
function UpdateStatus(id,nocounter){
	...
	var tglbayar = document.getElementById('tglbayar_'+id).value;
	var method = 'updateStatus';
	
	param='id='+id+'&status='+mystatus+'&nocounter='+nocounter+'&totalbayar='+totalbayar+'&tglbayar='+tglbayar+'&method='+method;
	tujuan='keu_slave_posting_pembayaran_tagihan_masuk.php';
	post_response_text(tujuan, param, respog);
