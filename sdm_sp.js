...
function saveSP()
{
        ...
        if (jenissp == '' || karyawanid == '' || masaberlaku == '' || tanggalsp == '' || pelanggaran == '' || penandatangan == '') {
                ...
                alert(altdlengkap);//Ganti alert ==Jo 11-03-2017==
        }
        else {
                ...
                param +=  '&jabatan2=' + jabatan2;
                if (confirm(cnfsimpan)) {//Ganti alert ==Jo 11-03-2017==
                ...
                if (con.readyState == 4) {
                        if (con.status == 200) {
                                ...
                                if (!isSaveResponse(con.responseText)) {
                                        ...
                                        alert(alsimpan);//Ganti alert ==Jo 11-03-2017==
                                        //clearForm();
                                        loadList();
                                }
                        }
