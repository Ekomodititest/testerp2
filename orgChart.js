 ...
 */
 ...
 function saveOrg()
 {
 	_orglimitpo = trim(document.getElementById('orglimitpo').value);
...
//++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 function clearForm()
 {
  	...
  	document.getElementById('orglimitpo').value ='';
...
function getCurrent(code)
{
  ...
  function  fillForm(arrtex)
  {
	...
	ct=ctobj.length;
	for (x = 0; x < ct; x++) {
		if (ctobj.options[x].value == arr[7])
	...
	document.getElementById('orglimitpo').value =arr[10];	
  } 	
}
