...
function viewDetail(supplierid,sampaitanggal,kodept,ev)
{
    param='supplierid='+supplierid+'&sampaitanggal='+sampaitanggal+'&kodept='+kodept;
    tujuan='keu_slave_2daftarhutang2detail.php'+"?"+param;  
    width='700';
    height='150';

    content="<iframe frameborder=0 width=100% height=100% src='"+tujuan+"'></iframe>"
    showDialog1('Detail Pembayaran Supplier '+supplierid,content,width,height,ev); 	
}
...
function browsemesin(nopengolahan,tanggal,kodeorg,periode_tahun,periode_bulan,ev)
{
   ...
   content="<iframe frameborder=0 width=100% height=100% src='"+tujuan+"'></iframe>"
   showDialog2('Detail Pengolahan (Mesin) '+nopengolahan,content,width,height,ev); 
...
function browsebarang(nopengolahan,tanggal,kodeorg,periode_tahun,periode_bulan,ev)
{
   ...
   content="<iframe frameborder=0 width=100% height=100% src='"+tujuan+"'></iframe>"
   showDialog2('Detail Pengolahan (Barang) '+nopengolahan,content,width,height,ev); 
...
function detailExcel(ev,tujuan)
{
   ...
   content="<iframe frameborder=0 width=100% height=100% src='"+tujuan+"'></iframe>"
   showDialog1('Detail Pengolahan Excel',content,width,height,ev); 
}