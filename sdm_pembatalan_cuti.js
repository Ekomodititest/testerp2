...
function AjukanBatalCuti(No){
	...
	param = 'karyawanid='+karyawanid+'&tanggal='+tanggal+'&persetujuan1='+persetujuan1+'&hrd='+hrd+'&namakaryawan='+namakaryawan+'&method='+method;
...
function SetujuiAjuanBatalCuti(Id, No){
	...
	param = 'Id='+Id+'&method='+method+'&persetujuan1='+persetujuan1+'&hrd='+hrd+'&kodeorg='+kodeorg+'&karyawanid='+karyawanid+'&tanggal='+tanggal;
