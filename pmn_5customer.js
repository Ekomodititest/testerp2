...
function simpanPlgn()
{
        ...
        if (kodecustomer == '' || namacustomer == '' || alamat=='' || kota=='' || telepon=='' || kontakperson=='') 
        {
...
function fillField(kodecustomer,namacustomer,alamat,kota,telepon,kontakperson,akun,plafon,nilaihutang,npwp,noseri,klcustomer,namaakun,kelompok)
{
