...
{
	$txt=$_POST['txt'];
$str=" select * from ".$dbname.".log_5supplier where namasupplier like '%".$txt."%' order by namasupplier asc";	
}
else//normal do
{
$str=" select * from ".$dbname.".log_5supplier where supplierid='".$idsupplier."' order by namasupplier asc";
}
