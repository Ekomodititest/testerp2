...
require_once('config/connection.php');
  ...
  echo"<fieldset><legend>[".$kodebarang."]".$namabarang."(".$satuan.")</legend>";
       echo"<table>
			...
			<tr><td>Tampak depan</td><td><img src='".$depan."' height=150px></td></tr>
			<tr><td>Tampak Samping</td><td><img src='".$samping."' height=150px></td></tr>
			<tr><td>Tampak Atas</td><td><img src='".$atas."' height=150px></td></tr>
	        </table>";
  echo"</fieldset>";
?>
