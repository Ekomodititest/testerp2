...
$mayor=$_POST['mayor'];
$str="select a.*,b.namabarang,b.satuan as satuanori from ".$dbname.".log_5stkonversi a left join ".$dbname.".log_5masterbarang b on a.kodebarang=b.kodebarang where a.kodebarang like '".$mayor."%'";
$res=mysql_query($str);
$no=0;
