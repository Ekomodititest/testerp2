...
function fillField(kelompokbarang,kodebarang,namabarang,satuan,minstok,nokartubin,konversi,inactive,kodeorder,merk,partnumber,inv_code,keterangan,iskma,isbbm){		
	...
	if(iskma == 0) {
		document.getElementById('iskma').checked = false;
	} else {
		document.getElementById('iskma').checked = true;
	}
	
	if(isbbm == 0) {
		document.getElementById('isbbm').checked = false;
	} else {
		document.getElementById('isbbm').checked = true;
	}
...
function simpanBarangBaru(){
		...
		if(document.getElementById('iskma').checked){
			iskma = 1;
		} else {
			iskma = 0;
		}
		
		if(document.getElementById('isbbm').checked){
			isbbm = 1;
		} else {
			isbbm = 0;
		}
		...
		param+='&kodeorder='+kodeorder+'&iskma='+iskma+'&isbbm='+isbbm;
			 ...
			 if(kl=='') {
				...
				alert(document.getElementById('a10').innerHTML + ' ' + document.getElementById('alertrequired').value);			 
			 }			 
     		 else {
