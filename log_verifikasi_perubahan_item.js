function DisplayList(){
	...
	itemasalsrch = trim(document.getElementById('itemasalsrch').value);
	itemperubahansrch = trim(document.getElementById('itemperubahansrch').value);
	
	param ='method='+Method+'&tanggaldibuatsrch='+tanggaldibuatsrch+'&tanggalsdsrch='+tanggalsdsrch;
	param+= '&noprsrch='+noprsrch+'&prprioritysrch='+prprioritysrch+'&itemasalsrch='+itemasalsrch+'&itemperubahansrch='+itemperubahansrch;
