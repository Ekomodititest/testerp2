...
function prosesPosting(maxRow, tipetrx,notransaksi){
    ...
    if(confirm('Are you sure?'))
    {
		...
		counterrow=1;
		while (counterrow<=maxRow)
		{
			doPostingmaterial(maxRow,tipetrx,counterrow,notransaksi); 
			counterrow++;		
		}
...
//periksa tanggal=====================================================================
    ...
    if (curdate < parseInt(_start) || curdate > parseInt(_end)) {
        alert(' Date out of range. \n\n Please Check Your Accounting Period.\n'+
			  ' Please Re-Login affter editing.\n Thank You.'+
		'\n\n Application Setup -> Accounting Period \n\n');
    }        
    else{        
		//====================================================================================         
		...
		else if(tipetransaksi== 5 && untukpt=='')
		{
			...
			document.getElementById('row'+currentRow).style.backgroundColor='pink';
...
function setPosting(gudang,notransaksi,cstatus)
{
param='notransaksi='+notransaksi+'&status='+cstatus+'&gudang='+gudang;
