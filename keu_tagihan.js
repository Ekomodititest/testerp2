...
function searchTrans() {
    ...
    var where = '[["noinvoice","'+notrans.value+'"]]';
...
function addDataTable() {
    ...
    var param = "noinvoice="+getValue('noinvoice')+"&tanggal="+getValue('tanggal')+"&tipeinvoice="+getValue('tipeinvoice');
...
function postingData(row)
{
	...
	//penambahan data baru u/ melakukan jurnal terhadap invoice in (16/11/2015
	kodeorg=document.getElementById('kodeorg_'+row).innerHTML;
	tanggal=document.getElementById('tanggal_'+row).innerHTML;
	nopo=document.getElementById('nopo_'+row).innerHTML;
	keterangan=document.getElementById('keterangan_'+row).innerHTML;
	nilaiinvoice=document.getElementById('nilaiinvoice_'+row).innerHTML;
	//end
    param='noinvoice='+noinvoice+'&kodeorg='+kodeorg+'&tanggal='+tanggal+'&nopo='+nopo+'&keterangan='+keterangan+'&nilaiinvoice='+nilaiinvoice;
	//alert(param);
