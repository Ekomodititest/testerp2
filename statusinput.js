...
function getLaporanJurnal()
{
    ...
    revisi =document.getElementById('revisi');
        ...
        revisiV    =revisi.options[revisi.selectedIndex].value;

    param='pt='+ptV+'&gudang='+gudangV+'&periode='+periodeV+'&periode1='+periode1V+'&revisi='+revisiV;
...
function getLaporanBukuBesar()
{
    ...
    param='pt='+ptV+'&gudang='+gudangV+'&periode='+periodeV+'&periode1='+periodeV1+'&revisi='+revisiV;
...
//function getLaporanNeracarevisi()
//{
//    pt	=document.getElementById('pt');
//    unit    =document.getElementById('gudang');
//    periode =document.getElementById('periode');
...
//
//    param='pt='+pt+'&unit='+unit+'&periode='+periode+'&periode1='+periode1+'&revisi='+revisi;
//    tujuan='keu_slave_2neracarevisi.php';
//    post_response_text(tujuan, param, respog);
//    function respog(){
//        if (con.readyState == 4) {
//            if (con.status == 200) {
...
//    revisi =document.getElementById('revisi');
    try{
        revisi =document.getElementById('revisi').options[document.getElementById('revisi').selectedIndex].value;
    }
    catch(err){
        revisi='0';  
    }	
...
function lihatDetailNeraca(noakundari,noakunsampai,periode,periode1,pt,unit,ev)
{
   param='noakundari='+noakundari+'&noakunsampai='+noakunsampai+'&periode='+periode+'&proses=preview';
   param+='&periode1='+periode1+'&pt='+pt+'&unit='+unit;
//   alert(param);
   tujuan='keu_slave_getNeracaDetail.php'+"?"+param;  
   width='700';
   height='400';
  
   content="<iframe frameborder=0 width=100% height=100% src='"+tujuan+"'></iframe>"
   showDialog1('Detail Neraca',content,width,height,ev); 
}
...
function detailNeracaKeExcel(ev,tujuan)
{
   width='700';
   height='400';
