...
function showDialog1(title,content,width,height,ev)
{
       if (document.getElementById('dynamic1')) {
        ...
        cont="<b >"+title+"</b><img src=images/closebig.gif align=right onclick=closeDialog() title='Close detail' class=closebtn onmouseover=\"this.src='images/closebigon.gif';\" onmouseout=\"this.src='images/closebig.gif';\"><br><br>";
		...
		document.getElementById('dynamic1').innerHTML=cont;
            ...
            document.getElementById('dynamic1').style.left = '250px';
