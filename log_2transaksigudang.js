...
{ 
        ...
        param='unit='+unit+'&tanggalawal='+tanggalawal+'&jenis='+jenis+'&kodebarang='+kodebarang+'&tanggalakhir='+tanggalakhir;
...
function transaksiGudangKeExcel(ev,tujuan)
{
        ...
        jenis =document.getElementById('jenis');
        kodebarang =document.getElementById('kodebarang').value;
		unitopt	=unit.options[unit.selectedIndex].value;
		unitname=unit.options[unit.selectedIndex].text;
		jenisopt	=jenis.options[jenis.selectedIndex].value;
		jenisname=jenis.options[jenis.selectedIndex].text;
		
		
        judul='Report Ms.Excel';	
        param='unit='+unitopt+'&tanggalawal='+tanggalawal+'&jenis='+jenisopt+'&kodebarang='+kodebarang+'&tanggalakhir='+tanggalakhir+'&unitname='+unitname+'&jenisname='+jenisname;
